...
import {  recordProfileView, getAllUsers, getUser, blockUser } from './browseController.js';
...
export { registerUser, fillInfo, confirmEmail, logUser, imageUpload, recordProfileView, likeUser,
    ...
    sendMessage, getNotifications, dislikeUser, sendNotification, blockUser };
...
export default { registerUser, fillInfo, confirmEmail, logUser, imageUpload, recordProfileView, likeUser,
    ...
    getNotifications, dislikeUser, sendNotification, blockUser };
