  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-pink-50 to-purple-100 py-8 px-4">
      <div className="w-full max-w-md mx-auto">
        ...
        {profiles.length === 0 ? (
          <div className="text-center p-12 bg-white shadow-lg rounded-xl border border-pink-100 relative">
            ...
            <div className="flex justify-center">
              <Button 
                onClick={getUsers}
                className="bg-[#ec4899] hover:bg-[#ec4899]/90 text-white font-medium py-2 px-6 rounded-lg shadow-md transition-all duration-300 flex items-center gap-2"
              >
